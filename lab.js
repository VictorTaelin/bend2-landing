(()=>{var{defineProperty:Re,getOwnPropertyNames:gi,getOwnPropertyDescriptor:ri}=Object,Mi=Object.prototype.hasOwnProperty;function Fi(a){return this[a]}var Si=(a)=>{var n=(gn??=new WeakMap).get(a),e;if(n)return n;if(n=Re({},"__esModule",{value:!0}),a&&typeof a==="object"||typeof a==="function"){for(var i of gi(a))if(!Mi.call(n,i))Re(n,i,{get:Fi.bind(a,i),enumerable:!(e=ri(a,i))||e.enumerable})}return gn.set(a,n),n},gn;var Gi=(a)=>a;function Wi(a,n){this[a]=Gi.bind(null,n)}var Bi=(a,n)=>{for(var e in n)Re(a,e,{get:n[e],enumerable:!0,configurable:!0,set:Wi.bind(n,e)})};var zo={};Bi(zo,{verify:()=>li,tool:()=>wi,respond:()=>Ti,level:()=>Tn,check:()=>Le,api_check:()=>si,Game:()=>je});var p=new Map;function Ze(a){return p.has(a)}function Je(a){return a}function rn(a){let n=p.get(a);if(n===void 0)throw Error("ENOENT: no such file: "+a);return n}function Mn(){}function Fn(a,n){p.set(a,n)}function Sn(){return"/"}function $e(a){let n=a.startsWith("/"),e=[];for(let i of a.split("/")){if(i===""||i===".")continue;if(i===".."&&e.length>0&&e[e.length-1]!=="..")e.pop();else if(i!==".."||!n)e.push(i)}return(n?"/":"")+(e.join("/")||(n?"":"."))}function Xe(...a){return $e(a.join("/"))}function Gn(...a){return $e("/"+a.join("/"))}function Ye(a){let n=a.lastIndexOf("/");return n<0?".":n===0?"/":a.slice(0,n)}var Ne={normalize:$e,join:Xe,dirname:Ye};function Wn(a){return decodeURIComponent(String(a).replace(/^file:\/\//,""))}function q(a,n,e,i){return{$:"Var",k:a,i:n,s:e,v:i}}function I(a,n,e){return{$:"Ref",k:a,s:n,b:e}}function Ea(a,n,e,i){return{$:"Sub",i:a,v:n,f:e,s:i}}function ee(a,n,e,i,o,y){return{$:"Let",k:a,i:n,q:y??a.map(()=>t()),v:e,f:i,s:o}}function z(a,n){return{$:"Typ",g:a,s:n}}function Ua(a){return{$:"Qnt",s:a}}function Z(a,n){return{$:"Qua",q:a,s:n}}function Wa(a,n,e){return{$:"Min",a,b:n,s:e}}function m(a,n,e,i,o,y){return{$:"All",q:a,k:n,i:e,A:i,B:o,s:y}}function k(a,n,e,i){return{$:"Lam",k:a,i:n,f:e,s:i}}function O(a,n,e){return{$:"App",f:a,x:n,s:e}}function sa(a,n,e,i=[]){return{$:"ADT",k:a,x:n,r:i,s:e}}function K(a,n,e){return{$:"Ctr",k:a,x:n,s:e}}function Ba(a,n,e,i,o){return{$:"Mat",k:a,h:n,m:e,s:i,ks:o}}function Da(a){return{$:"Efq",s:a}}function ga(a,n,e,i){return{$:"Eql",a,b:n,T:e,s:i}}function Ka(a){return{$:"Rfl",s:a}}function ne(a,n,e,i){return{$:"Rwt",e:a,p:n,f:e,s:i}}function ie(a,n){return{$:"Hol",k:a,s:n}}function Aa(a,n,e){return{$:"Ann",x:a,T:n,s:e}}function Pn(){return{$:"Emp"}}function Ya(a,n,e){return{$:"Bin",v:a,l:n,r:e}}function J(){return{$:"None"}}function t(){return{$:"Lone"}}function ra(){return{$:"Many"}}function ca(a,n,e){return{tm:Aa(a,q("_",-1,void 0,n)),ty:n,us:e}}function Na(a,n,e){return{tm:Aa(a,q("_",-1,void 0,n)),us:e}}function g(a,n,e,i,o,y){return{$:"Err",bok:a,ctx:n,exp:e,obs:i,spn:o,def:y}}function Pa(a){let n=a.charCodeAt(0);return n>=65&&n<=90||n>=97&&n<=122||n===95}function ba(a){let n=a.charCodeAt(0);return n>=65&&n<=90||n>=97&&n<=122||n>=48&&n<=57||n===95||n===46}function zn(a,n){let e=a,i=n;while(!0)switch(e.$){case"Emp":return null;case"Bin":{if(i===0)return e.v;let o=i%2===1;e=o?e.l:e.r,i=o?(i-1)/2:(i-2)/2;break}}}function ta(a,n,e){switch(a.$){case"Emp":return ta(Ya(null,a,a),n,e);case"Bin":{if(n===0)return Ya(e,a.l,a.r);if(n%2===1){let o=ta(a.l,(n-1)/2,e);return Ya(a.v,o,a.r)}let i=ta(a.r,(n-2)/2,e);return Ya(a.v,a.l,i)}}}function Fe(a,n,e){switch(a.$){case"Emp":return n;case"Bin":switch(n.$){case"Emp":return a;case"Bin":{let i=a.v===null?n.v:n.v===null?a.v:e(a.v,n.v),o=Fe(a.l,n.l,e),y=Fe(a.r,n.r,e);return Ya(i,o,y)}}}}function ma(a,n=0,e=1){switch(a.$){case"Emp":return[];case"Bin":{let i=a.v===null?[]:[[n,a.v]],o=ma(a.l,n+e*1,e*2),y=ma(a.r,n+e*2,e*2);return i.concat(o,y)}}}function Ai(a,n){for(let e=a;e!==null;e=e.n)if(e.k===n)return e.v;return null}function Qa(a,n,e){return{k:n,v:e,n:a}}function Dn(a,n){switch(a.$){case"None":return n;default:switch(n.$){case"None":return a;default:return ra()}}}function qn(a,n){switch(a.$){case"None":return n;case"Lone":switch(n.$){case"Many":return ra();default:return t()}case"Many":return ra()}}function Ci(a,n){switch(a.$){case"None":return J();case"Lone":return n;case"Many":return Dn(n,n)}}function Se(a,n){if(a.$==="None")return J();else return n}function Bn(a,n,e,i,o,y,c){if(qn(o,i).$!==i.$){let f=Be(o)+e;if(o.$==="Many")f=e+" (consumed more than once)";throw g(a,n,Be(i)+e,f,y,c)}}function b(){return Pn()}function An(a,n){return zn(a,n)??J()}function Fa(a,n){return Fe(a,n,Dn)}function Vi(a,n){return Fe(a,n,qn)}function Cn(a,n){return ta(a,n,J())}function ke(a,n,e,i=[]){if(e===0)return aa(a,K(n,i));else return k("_",0,(o)=>{return ke(a,n,e-1,[...i,o])})}function jn(a,n){return a.u===!0&&n.$==="Many"?t():n}function ui(a,n){let e=Ce(a.t)[1],i="EQ";for(let o=0;o<e.length&&o<n.length&&i==="EQ";o++)i=Qe(a.qs[o],n[o],e[o]);return i}function aa(a,n,e){let i=_(a);if(i.$==="Lam")return i.f(n);return O(i,n,e)}function Ce(a){let n=[],e=a;while(!0)switch(e.$){case"App":{n.push(e.x),e=e.f;break}default:return n.reverse(),[e,n]}}function Q(a,n="_"){if(a.$==="Var"&&a.i<0)return a;return q(n,-1,a.s,a)}function Oi(a){switch(a.$){case"Ctr":return K(a.k,a.x.map((n)=>Q(n)),a.s);case"ADT":return sa(a.k,a.x.map((n)=>Q(n)),a.s,a.r);case"All":return m(a.q,a.k,a.i,Q(a.A),a.B,a.s);case"Mat":return Ba(a.k,Q(a.h),Q(a.m),a.s,a.ks);case"Eql":return ga(Q(a.a),Q(a.b),Q(a.T),a.s);case"Min":return Wa(Q(a.a),Q(a.b),a.s);case"Typ":return z(Q(a.g),a.s);default:return a}}function ka(a){while(a.$==="Var"&&a.v!==void 0)a=a.v;return a}function _(a){let n=ka(a);while(n.$==="Ann")n=ka(n.x);return n}function W(a,n=null){switch(a.$){case"Var":{if(a.i<0)return a;let e=Ai(n,a.i);if(e===null)return I(a.k,a.s);else if(typeof e==="function")return e(a.s);else return e.s!==void 0||a.s===void 0||e.$==="Var"&&e.i<0?e:{...e,s:a.s}}case"Ref":return I(a.k[0]==="."&&a.k[1]!=="."?"Nat"+a.k:a.k,a.s,a.b);case"Sub":{let e=a.v,i=e.$==="PVar"||e.$==="PCtr"?(o)=>W(ue(e,o),n):W(e,n);return W(a.f,Qa(n,a.i,i))}case"Let":{let e=a,i=e.v.map((o)=>W(o,n));return ee(e.k,e.i,i,(o)=>{let y=n;for(let c=0;c<o.length;c++)y=Qa(y,e.i[c],o[c]);return W(e.f,y)},e.s,e.q)}case"Typ":return z(W(a.g,n),a.s);case"Qnt":case"Qua":return a;case"Min":return Wa(W(a.a,n),W(a.b,n),a.s);case"All":{let e=a,i=W(e.A,n);return m(e.q,e.k,e.i,i,(o)=>{return W(e.B,Qa(n,e.i,o))},e.s)}case"Lam":{let e=a;return k(e.k,e.i,(i)=>{return W(e.f,Qa(n,e.i,i))},e.s)}case"App":return O(W(a.f,n),W(a.x,n),a.s);case"ADT":return sa(a.k,a.x.map((e)=>W(e,n)),a.s,a.r);case"Ctr":return K(a.k,a.x.map((e)=>W(e,n)),a.s);case"Mat":return Ba(a.k,W(a.h,n),W(a.m,n),a.s,a.ks);case"Efq":return Da(a.s);case"Eql":return ga(W(a.a,n),W(a.b,n),W(a.T,n),a.s);case"Rfl":return Ka(a.s);case"Rwt":return ne(W(a.e,n),W(a.p,n),W(a.f,n),a.s);case"Hol":return ie(a.k,a.s);case"Ann":return Aa(W(a.x,n),W(a.T,n),a.s)}}function B(a,n=0){let e=ka(a);switch(e.$){case"Var":return q(e.k,e.i,e.s);case"Ref":return I(e.k,e.s,e.b);case"Sub":return Ea(e.i,e.v.$==="PVar"||e.v.$==="PCtr"?e.v:B(e.v,n),B(e.f,n),e.s);case"Let":{let i=e.k.map((y,c)=>q(y,n+c)),o=e.v.map((y)=>B(y,n));return ee(e.k,i.map((y,c)=>n+c),o,B(e.f(i),n+e.k.length),e.s,e.q)}case"Typ":return z(B(e.g,n),e.s);case"Qnt":case"Qua":return e;case"Min":return Wa(B(e.a,n),B(e.b,n),e.s);case"All":{let i=q(e.k,n);return m(e.q,e.k,n,B(e.A,n),B(e.B(i),n+1),e.s)}case"Lam":{let i=q(e.k,n);return k(e.k,n,B(e.f(i),n+1),e.s)}case"App":return O(B(e.f,n),B(e.x,n),e.s);case"ADT":return sa(e.k,e.x.map((i)=>B(i,n)),e.s,e.r);case"Ctr":return K(e.k,e.x.map((i)=>B(i,n)),e.s);case"Mat":return Ba(e.k,B(e.h,n),B(e.m,n),e.s,e.ks);case"Efq":return Da(e.s);case"Eql":return ga(B(e.a,n),B(e.b,n),B(e.T,n),e.s);case"Rfl":return Ka(e.s);case"Rwt":return ne(B(e.e,n),B(e.p,n),B(e.f,n),e.s);case"Hol":return ie(e.k,e.s);case"Ann":return Aa(B(e.x,n),B(e.T,n),e.s)}}function Qe(a,n,e){switch(a.$){case"None":return"EQ";default:break}let i=_(n),o=_(e);switch(o.$){case"Var":if(i.$==="Var"&&i.i===o.i)return"EQ";else return"GT";case"Ctr":{if(i.$==="Ctr"&&i.k===o.k&&i.x.length===o.x.length){let y="EQ";for(let c=0;c<i.x.length&&y!=="GT";c++){let f=Qe(t(),i.x[c],o.x[c]);y=f==="EQ"?y:f}if(y!=="GT")return y}for(let y of o.x)if(Qe(t(),i,y)!=="GT")return"LT";return"GT"}default:return"GT"}}function L(){return Pn()}function _a(a,n,e,i,o){return ta(a,n,{q:e,k:i,T:o})}function Ii(a,n){for(let[,e]of ma(n)){if(e.q.$==="None")continue;let i=$(a,e.T);if(i.$==="ADT"&&Ge(a,i,n).c.length===0)return!0}return!1}function _e(a){let n=ma(a);n.sort((i,o)=>i[0]-o[0]);let e=[];for(let[i,o]of n){while(e.length<i)e.push("_");e.push(o.k)}return e}function Vn(a,n){for(let e of a)if(e.k===n)return e;return null}function fa(){return{tlds:Object.create(null),ctrs:Object.create(null),order:[],hols:0,open:0,tmps:Object.create(null)}}function Ga(a,n){return a.ctrs[n]??null}function un(a,n){let e=_(Ga(a,n).T);for(let i=0;e.$==="All";i++)e=_(e.B(q(e.k,i)));return e.$==="ADT"?e.k:n}function Ge(a,n,e,i){let o=a.tlds[n.k];if(o===void 0||o.$!=="ADT")throw g(a,e,"a declared datatype (unknown: "+n.k+")",void 0,n.s,i);if(n.r.length===0)return o;let y=new Set(n.r);return{$:"ADT",n:o.n,g:o.g,T:o.T,c:o.c.filter((c)=>!y.has(c.k))}}var On=Je(Wn(new URL("./base.bend","file:///bend2/bend.ts"))),ge=Gn(Xe(Sn(),".bend","store")),In="https://hub.bend-lang.org";async function xn(a,n,e,i){let o=await fetch(In+"/"+n),y=o.ok?await o.text():"";if(!o.ok||!(await xi(y)).startsWith(e))throw g(a,L(),"a file at "+In+"/"+n+" hashing to "+e,void 0,i);return y}async function xi(a){return Buffer.from(await crypto.subtle.digest("SHA-256",new TextEncoder().encode(a))).toString("hex")}async function We(a,n,e,i,o){if(n.startsWith(ge+"/")&&!Ze(n)){let w=n.slice(ge.length+1).split("/")[0],T=ge+"/"+w+"/",N=await xn(a,w+"/manifest",w.slice(2),o);for(let[U,F]of N.trim().split(`
`).map((V)=>V.split(" ")))Mn(Ye(T+F),{recursive:!0}),Fn(T+F,await xn(a,w+"/"+F,U,o))}if(!Ze(n))throw g(a,L(),"no such file: "+n,void 0,o);let y=Je(n),c=i.get(y);if(c===null)throw g(a,L(),"an import cycle through "+n,void 0,o);if(c!==void 0){if(c!==e)throw g(a,L(),"one namespace per file ("+n+" is both '"+c+"' and '"+e+"')",void 0,o);return a.order.length}i.set(y,null);let f=n.slice(0,n.lastIndexOf("/")+1),d=Object.create(null),s=rn(n,"utf8"),l=s.split(`
`);for(let w=0;w<l.length;w++){let T=l[w].trim(),N=T.match(/^import(\s.*|)$/);if(N!==null){let U=N[1].match(/^\s+(\S+)(?:\s+as\s+([A-Za-z_][A-Za-z0-9_]*))?\s*(?:#.*)?$/),F=s.split(`
`,w).join(`
`).length+(w&&1)+l[w].indexOf(U===null?T:U[1]),V={src:s,beg:F,end:F};if(U===null||U[2]===void 0&&U[1]!=="Base")throw g(a,L(),"an import ('import Base', or 'import <path> as <Name>')","'"+T+"'",V);if(U[2]===void 0)await We(a,On,"",i,V);else{let j=Ne.normalize(U[1]);if(!j.endsWith(".bend"))throw g(a,L(),"an import of a .bend file","'"+U[1]+"'",V);let H=f+j,E=Ne.join(Ne.dirname(e),j);if(j.startsWith("/"))H=j,E=j;if(/^0x[0-9a-f]+\//.test(j))H=ge+"/"+j,E=j;d[U[2]]=E.replace(/\.bend$/,""),await We(a,H,d[U[2]],i,V)}l[w]="";continue}if(T!==""&&!T.startsWith("#"))break}let h=a.order.length;if(oo(a,f,l.join(`
`),e,d),y===On)for(let w of a.order.slice(h)){let T=a.tlds[w];if(T.$==="Def")T.b=!0}return i.set(y,e),h}function He(a,n){let e=n;for(let i=a.length-1;i>=0;i--){let[o,y,c,f,d]=a[i];e=m(o,y,c,f,e,d)}return e}function Ee(a,n){let e=$(a,n);return e.$==="All"?e:null}function za(a,n,e,i,o){let y=Ee(a,n);if(y===null)throw g(a,e,"unreachable (a telescope binds its parameters and fields)",void 0,o,i);return y}function tn(a,n,e,i,o,y){let c=n;for(let f of e)c=za(a,c,i,o,y).B(f);return c}function ti(a,n){let e=[],i=n;for(let o=Ee(a,i);o!==null;o=Ee(a,i))e.push([o.q,o.k,o.A]),i=o.B(q(o.k,e.length-1));return{doms:e,ret:$(a,i)}}function vi(a,n,e){let i=n;for(let o=0;o<a;o++)i=K("Succ",[i],e);return i}function Rn(a,n){let e=K("WNil",[],n);for(let i=31;i>=0;i--){let o=a>>>i&1;e=K("WCon",[K(o===1?"True":"False",[],n),e],n)}return e}function oe(a,n){return K("U32",[Rn(a,n)],n)}function pe(a,n="U32"){let e=_(a);if(e.$!=="Ctr"||e.k!==n||e.x.length!==1)return null;let i=0,o=0,y=_(e.x[0]);while(y.$==="Ctr"&&y.k==="WCon"&&y.x.length===2){let c=_(y.x[0]);if(c.$!=="Ctr"||c.x.length!==0||c.k!=="True"&&c.k!=="False")return null;if(c.k==="True")i+=2**o;o+=1,y=_(y.x[1])}if(o!==32||y.$!=="Ctr"||y.k!=="WNil"||y.x.length!==0)return null;return i}var vn=new DataView(new ArrayBuffer(4));function Li(a){return vn.setFloat32(0,a),vn.getUint32(0)}function Ki(a,n){return K("F32",[Rn(Li(a),n)],n)}function Be(a){switch(a.$){case"None":return"-";case"Lone":return"";case"Many":return"+"}}var Zn={n:10,t:9,r:13,"0":0,"\\":92,"'":39,'"':34};function Pi(a,n){for(let[e,i]of Object.entries(Zn))if(i===a&&(e!=="'"&&e!=='"'||e===n))return"\\"+e;if(a<32||a===127||a>=55296&&a<=57343||a>1114111)return null;return String.fromCodePoint(a)}function Ma(a,n=-1,e=[]){function i(d,s){if(d.$!=="App")return null;let{f:l,x:h}=d;if(l.$!=="App"||h.$!=="Lam")return null;let w=l.f;if(w.$!=="Ref"||w.k!=="Exists")return null;let T=f(l.x,2);e.push(h.k);let N=f(h.f,1);e.pop();let U="&"+h.k+":"+T+" -> "+N;return s>1?"("+U+")":U}function o(d,s){let l=0,h=d;while(h.$==="Ctr"&&h.k==="Succ"&&h.x.length===1)l+=1,h=h.x[0];if(h.$==="Ctr"&&h.k==="Zero"&&h.x.length===0)return String(l)+"n";if(l===0)return null;let w=String(l)+"n+"+f(h,1);return s>1?"("+w+")":w}function y(d,s){if(d.$!=="Ctr"||d.k!=="Chr"||d.x.length!==1)return null;let l=pe(d.x[0]);if(l===null||l>1114111)return null;return Pi(l,s)}function c(d){let s="",l=d;while(l.$==="Ctr"&&l.k==="SCon"&&l.x.length===2){let h=y(l.x[0],'"');if(h===null)return null;s+=h,l=l.x[1]}if(s===""||l.$!=="Ctr"||l.k!=="SNil"||l.x.length!==0)return null;return'"'+s+'"'}function f(d,s){switch(d.$){case"Var":return e.lastIndexOf(d.k)===d.i?d.k:d.k+"^"+String(d.i);case"Ref":return(e.includes(d.k)?d.k+"^":d.k)+(d.b===!0?"!":"");case"Sub":return f(d.f,s);case"Let":{let l=d.v.map((N)=>f(N,1));for(let N of d.k)e.push(N);let h=f(d.f,-1);e.length-=d.k.length;let T=d.k.map((N,U)=>Be(d.q[U])+N).join(" ")+" = "+l.join(" ")+"; "+h;return s>=0?"("+T+")":T}case"Typ":{let l=d.g;if(l.$==="Qua"&&l.q.$==="Lone")return"Type";if(l.$==="Qua"&&l.q.$==="Many")return"Data";return"Kind("+f(d.g,0)+")"}case"Qnt":return"Quant";case"Qua":return{None:"&0",Lone:"&1",Many:"&2"}[d.q.$];case"Min":{let l=f(d.a,2)+" <&> "+f(d.b,2);return s>1?"("+l+")":l}case"All":{let l=f(d.A,2);e.push(d.k);let h=f(d.B,1);e.pop();let w="@"+Be(d.q)+d.k+":"+l+" -> "+h;return s>1?"("+w+")":w}case"Lam":{e.push(d.k);let l=f(d.f,-1);e.pop();let h=d.k+" => "+l;return s>0?"("+h+")":h}case"App":{let l=i(d,s);if(l!==null)return l;let[h,w]=Ce(d),T=f(h,2),N=w.map((U)=>f(U,0));return T+"("+N.join(", ")+")"}case"ADT":{let l=d.x.map((T)=>f(T,0)),h=d.r.map((T)=>" - "+T+"{}").join(""),w=d.k+(l.length===0&&h===""?"":"<"+l.join(", ")+">")+h;return h!==""&&s>1?"("+w+")":w}case"Ctr":{let l=y(d,"'"),h=o(d,s)??(l!==null?"'"+l+"'":null)??c(d);if(h!==null)return h;let w=d.x.map((T)=>f(T,0));return d.k+"{"+w.join(", ")+"}"}case"Mat":{let l=[],h=d;while(h.$==="Mat")l.push(h.k+": "+f(h.h,1)),h=h.m;if(h.$!=="Efq")l.push(f(h,1));return"\\{"+l.join("; ")+"}"}case"Efq":return"\\{}";case"Eql":return"{"+f(d.a,1)+" == "+f(d.b,1)+" : "+f(d.T,1)+"}";case"Rfl":return"{==}";case"Hol":return"?"+d.k;case"Rwt":{let l=f(d.e,1),h=_(d.p),w=h.$==="Lam"?_(h.f):h,T="",N;if(h.$==="Lam"&&w.$==="Lam")e.push(h.k,w.k),N=f(w.f,1),e.length-=2,T=w.k===""?"":w.k+"@";else N=f(d.p,1);let U=f(d.f,-1),F="%"+T+l+" : "+N+"; "+U;return s>0?"("+F+")":F}case"Ann":return"{"+f(d.x,1)+" : "+f(d.T,1)+"}"}}return f(a,n)}function Me(a,n,e=[]){if(typeof n==="string")return n;else{let i=B(D(a,n),e.length);return Ma(i,-1,e)}}function zi(a,n){let e=ma(n);e.sort((c,f)=>c[0]-f[0]);let i=_e(n),o=0;for(let[,c]of e)o=Math.max(o,c.k.length);let y=e.length===0?"":`
Context:`;for(let[c,f]of e){let d=Ma(B(D(a,f.T),c),-1,i.slice(0,c));y+=`
- `+f.k.padEnd(o)+" : "+d}return y}function Di(a){let n=a.src.split(`
...
`)}function re(a,n,e){return"non-inferrable term '"+Me(a,e,_e(n))+"'"}function Jn(a){let n=_e(a.ctx),e=a.obs===void 0?`
- message  : `+Me(a.bok,a.exp,n):`
- expected : `+Me(a.bok,a.exp,n)+`
- observed : `+Me(a.bok,a.obs,n),i=a.def===void 0?"":" "+a.def,o=a.spn===void 0?"":`
`+Di(a.spn),y=i===""&&o===""?"":`
Location:`+i+o;return"Error:"+e+zi(a.bok,a.ctx)+y}var an=new Set(["def","type","law","match","case","do","return","for","exs","where","is","import","Type","Data","Kind","Quant"]),qi={"0":J(),"1":t(),"2":ra()};function ji(a,n,e,i="",o=Object.create(null)){return{book:a,dir:n,str:e,pos:0,sc:{stk:[],frs:0},ns:i,al:o,os:[],inst:null}}function Ha(a,n){return n-a.lastIndexOf(`
`,n-1)}function A(a,n){return{src:a.str,beg:n,end:a.pos}}function u(a,n){let e=a.pos<a.str.length?"'"+a.str[a.pos]+"'":"end of input";throw g(a.book,L(),n,e,{src:a.str,beg:a.pos,end:a.pos})}function Y(a){return a.pos<a.str.length?a.str[a.pos]:""}function x(a){let n=Y(a);return a.pos+=1,n}function R(a,n){if(a.str.charCodeAt(a.pos)!==n.charCodeAt(0))return!1;return n.length===1||a.str.startsWith(n,a.pos)}function M(a,n){if(!R(a,n))return!1;return a.pos+=n.length,!0}function r(a){let n=a.str;while(a.pos<n.length){let e=n.charCodeAt(a.pos);if(e===32||e===10||e===13||e===9){a.pos+=1;continue}if(e===35){while(a.pos<n.length&&n.charCodeAt(a.pos)!==10)a.pos+=1;continue}return}}function C(a,n){if(r(a),!M(a,n))u(a,"'"+n+"'")}function ea(a,n){if(r(a),!R(a,n))return!1;return!ba(a.str[a.pos+n.length]??"")}function na(a,n){if(!ea(a,n))return!1;return M(a,n),!0}function $n(a){if(r(a),!Pa(Y(a)))u(a,"a name");let n=a.pos;while(a.pos<a.str.length&&ba(a.str[a.pos]))a.pos+=1;let e=a.str.slice(n,a.pos);if(e.endsWith("."))u(a,"a name (a name cannot end in '.')");return e}function da(a){let n=$n(a);if(an.has(n))u(a,"a name (got the keyword '"+n+"')");return n}function Xn(a){if(M(a,"\\")){let e=Zn[x(a)];if(e===void 0)u(a,"an escape (\\n \\t \\r \\0 \\\\ \\' \\\")");return e}let n=a.str.codePointAt(a.pos);if(n===void 0)u(a,"a character");if(x(a),n>65535)x(a);return n}function ia(a,n,e){let i=a.sc.frs++;if(n!=="_")a.sc.stk.push([n,i,e]);return i}function oa(a,n){a.sc.stk.length=n}function Yn(a,n){let e=a.sc.stk;for(let i=e.length-1;i>=0;i--)if(e[i][0]===n)return e[i];return null}function Ri(a,n,e){let i=Yn(a,n);if(i!==null)return i[2]===void 0?q(n,i[1],e):i[2].$==="Var"?I(i[2].k,e):i[2];let o=wa(a,n);if(o!==n||n.includes(".")||o in a.book.tmps)return I(o,e);return q(n,a.sc.frs++,e)}function pa(a,n){return a.ns===""?n:a.ns+"."+n}function wa(a,n){let e=n.indexOf("."),i=pa(a,n);if(e!==-1&&n.slice(0,e)in a.al)i=a.al[n.slice(0,e)]+n.slice(e);if(i in a.book.tlds||i in a.book.ctrs||i in a.book.tmps)return i;return n}function Ve(a){if(r(a),M(a,"-"))return J();if(M(a,"+"))return ra();return t()}function en(a,n){let e=a.book;switch(n.$){case"Var":{if(Ga(e,wa(a,n.k))!==null)throw g(e,L(),"a braced constructor pattern ("+n.k+" is a constructor: write "+n.k+"{}, or rename the binder)",void 0,n.s);let i=ia(a,n.k);return{$:"PVar",k:n.k,i,s:n.s}}case"Ctr":{let i=Ga(e,n.k);if(i===null)throw g(e,L(),"a declared constructor (unknown: "+n.k+")",void 0,n.s);if(i.n!==n.x.length)throw g(e,L(),"a "+n.k+" pattern with "+String(i.n)+(i.n===1?" field":" fields"),void 0,n.s);let o=[];for(let y of n.x)o.push(en(a,y));return{$:"PCtr",k:n.k,x:o,s:n.s}}default:throw g(e,L(),"a pattern (a binder or a constructor)",Ma(B(W(n),0)),n.s)}}function G(a,n=0){r(a);let e=a.pos,i=Zi(a,e);return i.s??=A(a,e),Yi(a,i,n)}function Zi(a,n){let e=Y(a);if(Pa(e))return Ji(a,$n(a),n);if(/[0-9]/.test(e))return bi(a);switch(e){case"@":return Ln(a,!1);case"&":{let i=qi[a.str[a.pos+1]??""];if(i!==void 0)return x(a),x(a),Z(i,A(a,n));return Ln(a,!0)}case"+":{x(a);let i=G(a,5),o=A(a,n),y="";if(i.$==="ADT")y=i.k;else if(i.$==="Var"||i.$==="Ref")y=wa(a,i.k);let c=a.book.tlds[y];if(c===void 0||c.$!=="ADT"||c.g===0||c.g<c.n&&i.$!=="ADT")u(a,"a quantified datatype after + (+D<..> sets D's leading quantities to &2)");let f=i.$==="ADT"?i.x:Array.from({length:c.n},()=>Z(t(),o));return sa(y,f.map((d,s)=>s<c.g?Z(ra(),o):d),o)}case"\\":return x(a),C(a,"{"),Qi(a,n);case"%":return Hi(a,n);case"{":return Ei(a);case"(":return x(a),Hn(a,n,a.os.length);case"[":{x(a);let i=ae(a,"]"),o=A(a,n),y=K("Nil",[],o);for(let c=i.length-1;c>=0;c--)y=K("Con",[i[c],y],o);return y}case"'":return mi(a);case'"':return ki(a);case"?":{x(a);let i=da(a);if(i==="TODO")a.book.hols+=1;return ie(i,A(a,n))}default:u(a,"a term")}}function Ji(a,n,e){if(n==="Type")return z(Z(t()),A(a,e));if(n==="Data")return z(Z(ra()),A(a,e));if(n==="Quant")return Ua(A(a,e));if(n==="Kind"){C(a,"(");let i=G(a);return C(a,")"),z(i,A(a,e))}if(n==="do")return _i(a);if(n==="match")u(a,"a term (a match heads a def body, not a term)");if(n==="case")u(a,"a match heading this case (this case is orphaned)");if(n==="return")u(a,"a do-block heading this return");if(an.has(n))u(a,"a term (the keyword '"+n+"' cannot head one)");if(R(a,"{")){x(a);let i=ae(a,"}");return K(wa(a,n),i,A(a,e))}return Ri(a,n,A(a,e))}var $i=[[".|.",6,!1,".or"],[".^.",7,!1,".xor"],[".&.",8,!1,".and"],["||",2,!1,"Bool.or"],["&&",3,!1,"Bool.and"],["<=",4,!1,".is_le"],[">=",4,!1,".is_ge"],["<>",5,!0,""],["++",5,!0,"String.append"],["<<",9,!1,".shln"],[">>",9,!1,".shrn"],["&",1,!0,""],["|",1,!0,""],[">",4,!1,".is_gt"],["+",10,!1,".add"],["-",10,!1,".sub"],["*",11,!1,".mul"],["/",11,!1,".div"],["%",11,!1,".mod"]];function Xi(a){for(let n of $i){if(!R(a,n[0]))continue;let e=a.str[a.pos+n[0].length]??"";if((n[0]==="-"||n[0]==="+")&&(e===">"||Pa(e)))continue;if(n[0][0]===">"&&!/\s/.test(a.str[a.pos-1]??" "))continue;if(n[0]==="%"&&!/\s/.test(e))continue;return n}return null}function Ia(a,n){if(n.s===void 0)return;return A(a,n.s.beg)}function be(a){for(let n=a.pos-1;n>=0;n--){let e=a.str[n];if(e===`
`)return!0;if(e!==" "&&e!=="\r"&&e!=="\t")return!1}return!0}function Yi(a,n,e){let i=n;while(!0){if(r(a),be(a)&&(R(a,"(")||R(a,"[")))return i;if(R(a,"!(")){if(i.$==="Var"&&Yn(a,i.k)===null)i=I(i.k,i.s);if(i.$!=="Ref")u(a,"a named def before ! (only f!(..) offloads)");x(a),i.b=!0;continue}if(R(a,"(")){x(a);let f=i.$==="Ref"?a.book.tmps[i.k]:void 0,d=[];for(r(a);f!==void 0&&M(a,"~");r(a))d.push(G(a)),r(a),M(a,",");let s=d.concat(ae(a,")")),l=Ia(a,i);if(i.$==="Ref"&&f!==void 0){let h=a.sc.stk.reduce((T,N)=>Qa(T,N[1],I("\x00")),null),w=d.map((T)=>Ma(B(W(T,h)))).join(`
`);if(!w.includes("\x00")&&w.length<=2048){if(f.is[w]===void 0)f.is[w]=i.k+"~"+Object.keys(f.is).length,Ae({...f.p,sc:{stk:[],frs:a.sc.frs},os:[],inst:{k:f.is[w],xs:d}},a.book,f.u);i={...i,k:f.is[w]}}}for(let h of s)i=i.$==="Lam"&&a.sc.stk.some((w)=>w[2]===i)?Ea(i.i,h,i.f,l):O(i,h,l);continue}if(R(a,"[")){x(a);let f=a.os.length,d=G(a);C(a,"]");let s=Ia(a,i);if(Qn(a,a.os.splice(f),I("U32",s)),r(a),!be(a)&&M(a,"<-")){let l=G(a,2);i=O(O(O(O(I("Array.set",s),I("U32",s),s),i,s),d,s),l,s)}else i=O(O(O(I("Array.get",s),I("U32",s),s),i,s),d,s);continue}if(R(a,"<")&&!"-=<>".includes(a.str[a.pos+1]??"")&&!R(a,"<&>")&&(e<=4||/\S/.test(a.str[a.pos-1]??""))){x(a);let f=G(a,5);r(a);let d=Ia(a,i);if(R(a,">")||R(a,",")){if(i.$!=="Var"&&i.$!=="Ref")u(a,"a family name before <..> (a comparison here needs parens)");let s=[f];if(!M(a,">"))M(a,","),s.push(...ae(a,">"));let l=wa(a,i.k),h=a.book.tlds[l];if(h!==void 0&&h.$==="ADT"&&s.length+h.g===h.n)s.unshift(...Array.from({length:h.g},()=>Z(t(),d)));i=sa(l,s,d)}else{let s={$:"Ref",k:".is_lt",s:d};a.os.push(s),i=O(O(s,i,d),f,d)}continue}if(e===0&&M(a,"=>")){if(i.$!=="Var")u(a,"a lambda binder (one name: k => body)");let f=a.sc.stk.length,d=ia(a,i.k),s=nn(a);oa(a,f),i=k(i.k,d,s,i.s);continue}if(e===0&&M(a,"->")){let f=G(a),d=Ia(a,i);i=m(t(),"_",ia(a,"_"),i,f,d);continue}if(e<=5&&M(a,"<&>")){let f=G(a,5);i=Wa(i,f,Ia(a,i));continue}let o=Xi(a);if(o===null||o[1]<e||R(a,"<-"))return i;M(a,o[0]);let y=G(a,o[2]?o[1]:o[1]+1),c=Ia(a,i);if(o[0]==="<>")i=K("Con",[i,y],c);else if(o[0]==="&")i=O(O(I("Pair",c),i,c),y,c);else if(o[0]==="|")i=O(O(I("Or",c),i,c),y,c);else{let f={$:"Ref",k:o[3],s:c};if(o[3][0]===".")a.os.push(f);i=O(O(f,i,c),y,c)}}}function Qn(a,n,e){let i=Ce(e)[0];for(let o of n){if(i.$!=="Var"&&i.$!=="Ref"&&i.$!=="ADT")throw g(a.book,L(),"a type name after : (the operators' namespace)",void 0,i.s);o.k=wa(a,i.k+o.k)}}function ae(a,n){let e=[];while(!0){if(r(a),M(a,n))return e;let i=G(a);e.push(i),r(a),M(a,",")}}function Ln(a,n){let e=a.pos;x(a);let i=n?t():Ve(a),o=da(a);C(a,":");let y=G(a,1);C(a,"->");let c=a.sc.stk.length,f=ia(a,o),d=G(a);if(oa(a,c),n){let s=A(a,e);return O(O(I("Exists",s),y,s),k(o,f,d,s),s)}return m(i,o,f,y,d)}function Hn(a,n,e){r(a);let i=ye(a,Ha(a.str,a.pos)-1);if(r(a),i.$==="Reply"&&M(a,",")){let y=Hn(a,n,e);return K("Tuple",[i.x,y],A(a,n))}let o=Sa(i,[],()=>a.sc.frs++);if(M(a,":"))Qn(a,a.os.splice(e),G(a));return C(a,")"),o}function Qi(a,n){let e=[],i=Da();while(!0){if(r(a),M(a,"}"))break;let c=G(a);if(r(a),(c.$==="Var"||c.$==="Ref")&&M(a,":")){let f=G(a);e.push([wa(a,c.k),f,c.s]),r(a),M(a,";");continue}i=c,r(a),M(a,";"),C(a,"}");break}let o=A(a,n);i.s??=o;let y=i;for(let c=e.length-1;c>=0;c--)y=Ba(e[c][0],e[c][1],y,o,e[c][2]);return y}function Hi(a,n){x(a);let e=G(a);r(a);let i="",o=e;if(M(a,"@")){if(e.$!=="Var")u(a,"a name before @ (a rewrite binder is one name: %e@E : P)");i=e.k,o=G(a)}C(a,":");let y=a.sc.stk.length,c=a.sc.frs++;a.sc.stk.push(["_",c]);let f=i===""?a.sc.frs++:ia(a,i),d=G(a);oa(a,y),r(a),M(a,";");let s=nn(a),l=A(a,n);return ne(o,k("_",c,k(i,f,d,e.s),l),s,l)}function Ei(a){let n=a.pos;if(x(a),r(a),M(a,"=="))return C(a,"}"),Ka();let e=G(a);if(r(a),M(a,"==")){let o=G(a);C(a,":");let y=G(a);return C(a,"}"),ga(e,o,y)}if(M(a,"!=")){let o=A(a,a.pos-2),y=G(a);C(a,":");let c=G(a);C(a,"}");let f=A(a,n);return m(t(),"_",ia(a,"_"),ga(e,y,c,f),I("Empty",o),f)}C(a,":");let i=G(a);return C(a,"}"),Aa(e,i)}function bi(a){let n=a.pos,e="";while(/[0-9]/.test(Y(a)))e+=x(a);if(!M(a,"n")){if(R(a,".")&&/[0-9]/.test(a.str[a.pos+1]??"")){let f=e+x(a);while(/[0-9]/.test(Y(a)))f+=x(a);if(/[eE]/.test(Y(a))&&/[0-9+-]/.test(a.str[a.pos+1]??"")){f+=x(a)+(/[+-]/.test(Y(a))?x(a):"");while(/[0-9]/.test(Y(a)))f+=x(a)}let d=Math.fround(Number(f));if(!isFinite(d))u(a,"a float literal with a finite f32 value (got "+f+")");return Ki(d,A(a,n))}if(ba(Y(a)))u(a,"a numeric literal (NUMBER is U32, NUMBER n is Nat)");let c=Number(e);if(c>4294967295)u(a,"a u32 literal up to 4294967295 (got "+e+")");return oe(c,A(a,n))}let i=Number(e);if(i>Number.MAX_SAFE_INTEGER)u(a,"a nat literal up to "+Number.MAX_SAFE_INTEGER+"n (got "+e+"n)");let o;if(M(a,"+"))o=G(a);else{if(ba(Y(a)))u(a,"a nat literal (NUMBER n)");o=K("Zero",[],A(a,n))}let y=A(a,n);return vi(i,o,y)}function mi(a){let n=a.pos;x(a);let e=Xn(a);if(Y(a)!=="'")u(a,"a closing '");x(a);let i=A(a,n);return K("Chr",[oe(e,i)],i)}function ki(a){let n=a.pos;x(a);let e=[];while(Y(a)!=='"'){if(a.pos>=a.str.length)u(a,'a closing "');e.push(Xn(a))}x(a);let i=A(a,n),o=K("SNil",[],i);for(let y=e.length-1;y>=0;y--)o=K("SCon",[K("Chr",[oe(e[y],i)],i),o],i);return o}function _i(a){let n=da(a);C(a,"<");let e=ae(a,">");return C(a,":"),En(a,n,e.slice(0,-1),e.length===0?null:e[e.length-1])}function En(a,n,e,i){function o(F,V,j,H){let E=I(wa(a,n+"."+F),H);for(let Te of e.concat(V,i===null?[]:[i],j))E=O(E,Te,H);return E}r(a);let y=a.pos;if(na(a,"return")){let F=G(a);return o("pure",[],[F],A(a,y))}let c=G(a);r(a);let f=c.$==="Var"&&M(a,":"),d=f?G(a,1):c;r(a);let s=f&&R(a,"=")&&!R(a,"==");if(s)x(a);else if(f)C(a,"<-");else if(!M(a,"<-"))return c;let l=G(a);r(a),M(a,";");let h=A(a,y),w=f&&c.$==="Var"?c.k:"_",T=a.sc.stk.length,N=ia(a,w),U=En(a,n,e,i);if(oa(a,T),s)return ee([w],[N],[Aa(l,d,h)],U,h);return o("bind",[d],[l,k(w,N,U,h)],h)}function ye(a,n=0){r(a);let e=a.pos;if(ea(a,"match"))return ao(a,n);let i=Ve(a),o=[];if(i.$!=="Lone"){let s=i.$==="None"||Pa(Y(a))?da(a):"";if(r(a),s!==""&&R(a,"=")&&!R(a,"=="))o=[q(s,0,A(a,e))],C(a,"=");else a.pos=e,i=t()}if(i.$==="Lone"){o=[G(a)],r(a);while(!be(a)&&Pa(Y(a))&&!pi(a))o.push(G(a)),r(a);if(o.length===1&&!(R(a,"=")&&!R(a,"==")))return{$:"Reply",x:o[0],s:A(a,e)};C(a,"=")}let y=[];for(let s of o)y.push(G(a));r(a),M(a,";");let c=a.sc.stk.length,f=o.map((s)=>{if(o.length>1&&s.$!=="Var")throw g(a.book,L(),"a name (a parallel let binds names; destructure in its body)",void 0,s.s);return en(a,s)}),d=ye(a,n);return oa(a,c),{$:"Local",k:f,q:i,v:y,f:d}}function pi(a){let n="";for(let e=a.pos;e<a.str.length&&ba(a.str[e]);e++)n+=a.str[e];return an.has(n)}function nn(a){r(a);let n=ye(a,Ha(a.str,a.pos)-1);return Sa(n,[],()=>a.sc.frs++)}function Kn(a){let n=[];while(!0){if(n.push(G(a)),r(a),M(a,":"))return n;M(a,",")}}function ao(a,n){r(a);let e=a.pos;na(a,"match");let i=Kn(a);r(a);let o=Ha(a.str,a.pos),y=[];while(o>n&&ea(a,"case")&&Ha(a.str,a.pos)>=o){let c=Ha(a.str,a.pos);na(a,"case");let f=Kn(a);if(f.length!==i.length)u(a,String(i.length)+" patterns (one per scrutinee)");let d=a.sc.stk.length,s=[];for(let h of f)s.push(en(a,h));let l=ye(a,c);oa(a,d),y.push({p:s,f:l})}return{$:"Match",e:i,r:y,s:A(a,e)}}function me(a,n){let e=[];while(!0){if(r(a),M(a,n))return e;let i=n===")"&&M(a,"~"),o=i?J():Ve(a),y=a.pos,c=da(a),f=A(a,y);if(r(a),o.$==="Lone"&&!R(a,":"))e.push([J(),c,ia(a,c),Ua(f),f]);else{C(a,":");let d=G(a);e.push([o,c,ia(a,c,i?a.inst?.xs.shift():void 0),d,f])}r(a),M(a,",")}}function on(a,n){if(a.book.tlds[n]!==void 0||a.inst===null&&n in a.book.tmps)u(a,"a fresh name (duplicate declaration: "+n+")")}function Ae(a,n,e=!1){let i=a.pos;na(a,"def");let o=da(a),y=wa(a,o),c=n.tlds[y];if(c!==void 0&&c.$==="Def"&&c.v===null&&c.b!==!0&&!c.i){if(e)c.u=!0;eo(a,n,y,c);return}let f=a.inst?.k??pa(a,o);on(a,f);let d=a.sc.stk.length;if(C(a,"("),r(a),a.inst===null&&R(a,"~")){n.tmps[f]={p:{...a,pos:i},u:e,is:Object.create(null)},a.pos=i,a.inst={k:f,xs:[]},Ae(a,fa(),e),a.inst=null;return}let s=me(a,")");C(a,"->");let l=G(a),h={$:"Def",n:s.length,T:W(He(s,l)),v:null};if(e)h.u=!0;n.tlds[f]=h;let w=s.map((T)=>({$:"PVar",k:T[1],i:T[2],s:T[4]}));bn(a,n,f,h,w,d)}function eo(a,n,e,i){let o=a.sc.stk.length;C(a,"(");let y=[];while(!0){if(r(a),M(a,")"))break;let c=a.pos,f=da(a);y.push({$:"PVar",k:f,i:ia(a,f),s:A(a,c)}),r(a),M(a,",")}i.n=y.length,bn(a,n,e,i,y,o)}function bn(a,n,e,i,o,y){if(C(a,":"),ea(a,"import")){i.i=[];while(na(a,"import")){C(a,'"');let f="";while(Y(a)!=='"'&&Y(a)!=="")f+=x(a);if(C(a,'"'),!/\.(c|js)$/.test(f))u(a,"a .c or .js path");i.i.push(a.dir+f)}oa(a,y),n.order.push(e);return}let c=ye(a);oa(a,y),i.v=W(B(W(Sa(c,o,()=>a.sc.frs++)))),n.order.push(e)}function no(a,n){na(a,"law");let e=pa(a,da(a));on(a,e),C(a,":");let i=a.sc.stk.length,o=[];while(ea(a,"for")||ea(a,"exs")){let f=na(a,"for");if(!f)na(a,"exs");let d=f?Ve(a):t(),s=a.pos,l=da(a),h=A(a,s);C(a,":");let w=G(a);if(ea(a,"where")){let T=a.pos;na(a,"where");let N=A(a,T),U=a.sc.stk.length,F=ia(a,l),V=G(a);oa(a,U),w=O(O(I("Exists",N),w,h),k(l,F,V,h),h)}o.push([f,d,l,ia(a,l),w,h])}let y=nn(a);for(let f=o.length-1;f>=0;f--){let[d,s,l,h,w,T]=o[f];y=d?m(s,l,h,w,y,T):O(O(I("Exists",T),w,T),k(l,h,y,T),T)}oa(a,i);let c=0;while(c<o.length&&o[c][0])c+=1;n.tlds[e]={$:"Def",n:c,T:W(y),v:null},n.order.push(e)}function io(a,n){na(a,"type");let e=pa(a,da(a));on(a,e);let i=a.sc.stk.length;r(a);let o=M(a,"<")?me(a,">"):[];if(!na(a,"is"))u(a,"'is'");let y=G(a);C(a,":");let c=[],f=o.findIndex((d)=>d[3].$!=="Qnt");n.tlds[e]={$:"ADT",n:o.length,g:f<0?o.length:f,T:W(He(o,y)),c};while(!0){if(r(a),a.pos>=a.str.length||!Pa(Y(a)))break;if(["def","type","law"].some((T)=>ea(a,T)))break;let d=pa(a,da(a));if(Ga(n,d)!==null)u(a,"a fresh constructor name (duplicate declaration: "+d+")");C(a,"{");let s=a.sc.stk.length,l=me(a,"}"),h=sa(e,o.map((T)=>q(T[1],T[2]))),w={k:d,n:l.length,T:W(He(o.concat(l),h))};oa(a,s),c.push(w),n.ctrs[d]=w}oa(a,i),n.order.push(e)}function oo(a,n,e,i="",o=Object.create(null)){let y=ji(a,n,e,i,o);while(!0){if(r(y),y.pos>=y.str.length)return a;if(y.sc={stk:[],frs:0},M(y,"@")){if(!na(y,"unsafe"))u(y,"'unsafe' (the one decorator)");if(r(y),!ea(y,"def"))u(y,"'def' (@unsafe marks the def below it)");Ae(y,a,!0);continue}if(ea(y,"def")){Ae(y,a);continue}if(ea(y,"type")){io(y,a);continue}if(ea(y,"law")){no(y,a);continue}u(y,"'def', 'type' or 'law'")}}function va(a,n,e){function i(o){if(o.$==="Var")return o.i!==n?o:ue(e,o.s);else return Ea(n,e,o)}switch(a.$){case"Match":{let o=a.e.map(i),y=a.r.map((c)=>({p:c.p,f:va(c.f,n,e)}));return{$:"Match",e:o,r:y,s:a.s}}case"Local":{let o=a.v.map(i),y=va(a.f,n,e);return{$:"Local",k:a.k,q:a.q,v:o,f:y}}case"Reply":return{$:"Reply",x:Ea(n,e,a.x),s:a.s}}}function xa(a,n,e){if(a.e.length===0&&a.r.length>0)return Sa(a.r[0].f,n,e);else if(a.e.length===0)throw g(fa(),L(),"a case (this match has no row to return)",void 0,a.s);else if(n.length===0){let i=a.e[0];while(i.$==="Sub")i=i.f;switch(i.$){case"Var":throw g(fa(),L(),"match scrutinees in binder order (this variable is unbound, consumed, or out of order: reorder the match)",void 0,i.s);case"Ctr":throw g(fa(),L(),"an undestructed scrutinee (this value is already a constructor: bind its fields directly; if an outer match destructed it, fold the pattern into the outer case)",void 0,a.s);default:throw g(fa(),L(),"a parameter or field scrutinee (a match cannot scrutinize a computed value: give it its own def)",void 0,i.s??a.s)}}else{let i=n[0],o=a.e[0],y=so(a.r),c=n.find((f)=>o.$==="Var"&&f.i===o.i);if(c!==void 0&&y===null&&a.r.length>0){let f=fo(a.r,c);return xa({$:"Match",e:a.e.slice(1),r:f,s:a.s},n,e)}else if(c===i)if(y===null)return Da(a.s);else{let f=ho(y.x,e),d=yo(a.r,i,y.k,f),s=f.map((N)=>ue(N)).concat(a.e.slice(1)),l=f.concat(n.slice(1)),h=xa({$:"Match",e:s,r:d,s:a.s},l,e),w=co(a.r,y.k),T=xa({$:"Match",e:a.e,r:w,s:a.s},n,e);return Ba(y.k,h,T,a.s,y.s)}else{let f=xa(a,n.slice(1),e);return k(i.k,i.i,f,i.s)}}}function yo(a,n,e,i){let o={$:"PCtr",k:e,x:i,s:n.s};return a.flatMap((y)=>{let c=y.p[0];switch(c.$){case"PCtr":if(c.k!==e)return[];else if(c.x.length!==i.length)throw g(fa(),L(),"a "+e+" pattern with "+String(i.length)+" fields",void 0,c.s);else{let f=va(y.f,n.i,o);return[{p:c.x.concat(y.p.slice(1)),f}]}case"PVar":{let f=va(y.f,c.i,n),d=va(f,n.i,o);return[{p:i.concat(y.p.slice(1)),f:d}]}}})}function co(a,n){return a.filter((e)=>{let i=e.p[0];return i.$!=="PCtr"||i.k!==n})}function fo(a,n){return a.map((e)=>{let i=e.p[0];if(i.$==="PVar"){let o=va(e.f,i.i,n);return{p:e.p.slice(1),f:o}}else throw g(fa(),L(),"a variable pattern (this column has no constructor row)",void 0,i.s)})}function so(a){for(let n of a){let e=n.p[0];if(e.$==="PCtr")return e}return null}function ho(a,n){return a.map((e)=>{if(e.$==="PVar")return e;let i=n();return{$:"PVar",k:"_"+String(i),i,s:e.s}})}function ue(a,n){switch(a.$){case"PVar":return q(a.k,a.i,n??a.s);case"PCtr":{let e=a.x.map((i)=>ue(i,n));return K(a.k,e,n??a.s)}}}function Sa(a,n,e){switch(a.$){case"Reply":if(n.length===0)return a.x;else{let i=n[0],o=Sa(a,n.slice(1),e);return k(i.k,i.i,o,i.s)}case"Local":{if(a.k.length===1&&a.k[0].$==="PCtr"){let c={p:[a.k[0]],f:a.f};return xa({$:"Match",e:[a.v[0]],r:[c],s:a.v[0].s},n,e)}let i=a.k,o=Sa(a.f,i,e);for(let c of i){if(o.$!=="Lam")throw g(fa(),L(),"a parameter or field scrutinee (a match cannot scrutinize a local binder: give it its own def)",void 0,c.s);o=o.f}let y=ee(i.map((c)=>c.k),i.map((c)=>c.i),a.v,o,i[0].s,i.map(()=>a.q));return Sa({$:"Reply",x:y},n,e)}case"Match":return xa(a,n,e)}}function $(a,n){let e=[],i=n,o=null;a:while(!0){e:switch(i.$){case"Var":if(i.v===void 0)break e;else{if(i.i===-1)e.push({$:"VAR",l:i,a:i.v.$==="Ann"?i.v:void 0});o=null,i=i.v;continue a}case"Ann":{i=i.x;continue a}case"Min":{e.push({$:"MNA",b:i.b,s:i.s}),i=i.a;continue a}case"Let":{let y=i;i=y.f(y.v.map((c,f)=>Q(c,y.k[f])));continue a}case"App":{e.push({$:"APP",x:Q(i.x),s:i.s}),o=null,i=i.f;continue a}case"Lam":if(e.length===0||e[e.length-1].$!=="APP")break e;else{let y=e.pop();if(o!==null&&o.n===0)o=null;else if(o!==null){let{t:c,n:f}=o;o={t:()=>aa(c(),y.x,y.s),n:f-1}}i=i.f(y.x);continue a}case"Mat":if(e.length===0||e[e.length-1].$!=="APP")break e;else{let y=e.pop();e.push({$:"MAT",t:i,e:y.x,lhs:o,s:y.s}),i=y.x,o=null;continue a}case"Efq":{if(o!==null&&o.n>0&&e.length>0&&e[e.length-1].$==="APP")i=o.t();break e}case"Rwt":{if($(a,i.e).$==="Rfl"){i=i.f;continue a}break e}case"Ref":{let y=a.tlds[i.k];if(y===void 0)break e;if(y.$==="ADT"){if(y.n===0)i=sa(i.k,[],i.s);break e}let c=0;while(c<y.n&&c<e.length&&e[e.length-1-c].$==="APP")c+=1;if(c<y.n||y.v===null)break e;let f=i;o={t:()=>f,n:y.n},i=y.v;continue a}default:break e}o=null;e:while(!0){let y=e.pop();if(y===void 0)return i;else switch(y.$){case"VAR":{i=Oi(i),y.l.v=y.a===void 0?i:Aa(i,Q(y.a.T),y.a.s),y.l.i=-2;continue a}case"APP":{i=aa(i,y.x,y.s);continue e}case"MNA":{if(i.$==="Qua"&&i.q.$==="Many"){i=y.b;continue a}if(i.$==="Qua"&&i.q.$==="None")continue e;e.push({$:"MNB",a:i,s:y.s}),i=y.b;continue a}case"MNB":{if(i.$==="Qua"&&i.q.$==="Many")i=y.a;else if(i.$!=="Qua"||i.q.$==="Lone"&&y.a.$!=="Qua")i=Wa(y.a,i,y.s);continue e}case"MAT":if(i.$==="Ctr"){let c=i,f=y.t;n:while(!0)switch(f.$){case"Ann":{f=f.x;continue n}case"Mat":if(f.k===c.k){let d=y.lhs;if(d===null)o=null;else o={t:()=>ke(d.t(),c.k,c.x.length),n:d.n-1+c.x.length};for(let s=c.x.length-1;s>=0;s--)e.push({$:"APP",x:Q(c.x[s])});i=f.h;continue a}else{f=f.m;continue n}case"Efq":{i=aa(y.lhs===null?y.t:y.lhs.t(),y.e,y.s);continue e}default:{o=y.lhs,e.push({$:"APP",x:c}),i=f;continue a}}}else{i=aa(y.lhs===null?y.t:y.lhs.t(),y.e,y.s);continue e}}}}}function D(a,n){let e=$(a,n);switch(e.$){case"Var":return q(e.k,e.i,e.s);case"Ref":return I(e.k,e.s,e.b);case"Sub":return Ea(e.i,e.v.$==="PVar"||e.v.$==="PCtr"?e.v:D(a,e.v),D(a,e.f),e.s);case"Typ":return z(D(a,e.g),e.s);case"Qnt":case"Qua":return e;case"Min":return Wa(D(a,e.a),D(a,e.b),e.s);case"All":return m(e.q,e.k,e.i,D(a,e.A),(i)=>{return D(a,e.B(i))},e.s);case"Lam":return k(e.k,e.i,(i)=>{return D(a,e.f(i))},e.s);case"App":return O(e.f.$==="Ref"?e.f:D(a,e.f),D(a,e.x),e.s);case"ADT":return sa(e.k,e.x.map((i)=>D(a,i)),e.s,e.r);case"Ctr":return K(e.k,e.x.map((i)=>D(a,i)),e.s);case"Mat":return Ba(e.k,D(a,e.h),D(a,e.m),e.s,e.ks);case"Efq":return Da(e.s);case"Eql":return ga(D(a,e.a),D(a,e.b),D(a,e.T),e.s);case"Rfl":return Ka(e.s);case"Rwt":return ne(D(a,e.e),D(a,e.p),D(a,e.f),e.s);case"Hol":return ie(e.k,e.s)}}function v(a,n,e,i,o=0){if(e===i)return!0;let y=$(n,e),c=$(n,i);if(y===c)return!0;if(y.$==="Lam"||c.$==="Lam"){let f=y.$==="Lam"?y.k:c.k,d=q(f,o);return v(a,n,aa(y,d),aa(c,d),o+1)}switch(y.$){case"Var":return c.$==="Var"&&y.i===c.i;case"Ref":return c.$==="Ref"&&y.k===c.k;case"Typ":{if(c.$!=="Typ")return!1;if(a==="EQ")return v("EQ",n,y.g,c.g,o);let f=$(n,y.g),d=$(n,c.g);if(f.$==="Qua"&&f.q.$==="Many"||d.$==="Qua"&&d.q.$!=="Many")return!0;if(f.$==="Min"){let s=v("LE",n,z(f.a),c,o),l=v("LE",n,z(f.b),c,o);return s&&l}if(d.$==="Min"){let s=v("LE",n,y,z(d.a),o),l=v("LE",n,y,z(d.b),o);return s||l}return v("LE",n,f,d,o)}case"Qnt":return c.$==="Qnt";case"Qua":return c.$==="Qua"&&y.q.$===c.q.$;case"Min":return c.$==="Min"&&v("EQ",n,y.a,c.a,o)&&v("EQ",n,y.b,c.b,o);case"All":{let f=q(y.k,o);return c.$==="All"&&y.q.$===c.q.$&&v(a,n,c.A,y.A,o)&&v(a,n,y.B(f),c.B(f),o+1)}case"App":return c.$==="App"&&v("EQ",n,y.f,c.f,o)&&v("EQ",n,y.x,c.x,o);case"ADT":{if(c.$!=="ADT"||y.k!==c.k||y.x.length!==c.x.length)return!1;if(a==="EQ"&&y.r.length!==c.r.length)return!1;return c.r.every((f)=>y.r.includes(f))&&y.x.every((f,d)=>v("EQ",n,f,c.x[d],o))}case"Ctr":return c.$==="Ctr"&&y.k===c.k&&y.x.length===c.x.length&&y.x.every((f,d)=>v("EQ",n,f,c.x[d],o));case"Mat":return c.$==="Mat"&&y.k===c.k&&v("EQ",n,y.h,c.h,o)&&v("EQ",n,y.m,c.m,o);case"Efq":return c.$==="Efq";case"Eql":return c.$==="Eql"&&v("EQ",n,y.a,c.a,o)&&v("EQ",n,y.b,c.b,o)&&v("EQ",n,y.T,c.T,o);case"Rfl":return c.$==="Rfl";case"Hol":return c.$==="Hol"&&y.k===c.k;case"Rwt":return c.$==="Rwt"&&v("EQ",n,y.e,c.e,o)&&v("EQ",n,y.p,c.p,o)&&v("EQ",n,y.f,c.f,o);default:return!1}}function La(a,n,e,i,o,y,c=[]){switch(e.$){case"Var":{if(e.i<0&&e.v!==void 0)return La(a,n,ka(e),i,o,y,c);let f=zn(o,e.i);if(f===null)throw g(a,o,"a bound variable",e,e.s,n.def);else return ca(q(e.k,e.i,e.s),f.T,ta(b(),e.i,i))}case"Ref":{let f=a.tlds[e.k];if(f===void 0)throw g(a,o,"a defined name",e,e.s,n.def);switch(i.$){case"None":break;default:{if(e.k===n.def&&n.u!==!0&&ui(n,c)!=="LT")throw g(a,o,"a decreasing self-call (some live argument must shrink)",e,e.s,n.def);if(e.k===n.def)return ca(I(e.k,e.s,e.b),f.T,b());if(f.$==="Def"&&f.v===null&&f.b!==!0&&!f.i)throw g(a,o,"a filled definition (an unfilled law is a dead claim: live code cannot use it)",e,e.s,n.def);break}}if(f.$==="ADT"&&f.n>0)throw g(a,o,"a family instance (write "+e.k+"<..>)",e,e.s,n.def);return ca(I(e.k,e.s,e.b),f.T,b())}case"Typ":{let f=P(a,n,e.g,J(),Ua(e.s),o,y);return ca(z(f.tm,e.s),z(Z(t()),e.s),b())}case"Qnt":return ca(Ua(e.s),z(Z(t()),e.s),b());case"Qua":return ca(Z(e.q,e.s),Ua(e.s),b());case"Min":{let f=P(a,n,e.a,i,Ua(e.s),o,y),d=P(a,n,e.b,i,Ua(e.s),o,y);return ca(Wa(f.tm,d.tm,e.s),Ua(e.s),Fa(f.us,d.us))}case"All":{let f=_a(o,y,e.q,e.k,e.A),d=P(a,n,e.A,J(),z(Z(jn(n,e.q)),e.s),o,y),s=P(a,n,e.B(q(e.k,y)),J(),z(Z(t()),e.s),f,y+1);return ca(m(e.q,e.k,y,d.tm,s.tm,e.s),z(Z(t()),e.s),b())}case"App":{if(e.f.$==="Lam")return La(a,n,e.f.f(e.x),i,o,y,c);let f=La(a,n,e.f,i,o,y,[e.x,...c]),d=$(a,f.ty);if(d.$!=="All")throw g(a,o,"a function type",f.ty,e.s,n.def);let s=P(a,n,e.x,Se(d.q,i),d.A,o,y);return ca(O(f.tm,s.tm,e.s),d.B(e.x),Fa(f.us,s.us))}case"ADT":{let f=Ge(a,e,o,n.def);if(e.x.length!==f.n)throw g(a,o,e.k+" with "+String(f.n)+(f.n===1?" parameter":" parameters"),e,e.s,n.def);let d=[],s=f.T,l=b();for(let h of e.x){let w=za(a,s,o,n.def,e.s),T=Se(w.q,i),N=P(a,n,h,T,w.A,o,y);d.push(N.tm),l=Fa(l,N.us),s=w.B(h)}return ca(sa(e.k,d,e.s,e.r),s,l)}case"Eql":{let f=P(a,n,e.T,J(),z(Z(t()),e.s),o,y),d=P(a,n,e.a,J(),e.T,o,y),s=P(a,n,e.b,J(),e.T,o,y);return ca(ga(d.tm,s.tm,f.tm,e.s),z(Z(ra()),e.s),b())}case"Ann":{P(a,n,e.T,J(),z(Z(t()),e.s),o,y);let f=P(a,n,e.x,i,e.T,o,y);return{tm:f.tm,ty:e.T,us:f.us}}default:{if(e.$==="Ctr"&&Ga(a,e.k)===null)throw g(a,o,"a declared constructor",e,e.s,n.def);throw g(a,o,"an annotated term (cannot infer)",e,e.s,n.def)}}}function P(a,n,e,i,o,y,c){switch(e.$){case"Var":{if(e.i<0&&e.v!==void 0)return P(a,n,ka(e),i,o,y,c);break}case"Lam":{let d=$(a,o);if(d.$!=="All")throw g(a,y,o,re(a,y,e),e.s,n.def);let s=q(e.k,c),l=n;if(n.n>0)l={...n,t:aa(n.t,s),n:n.n-1};let h=_a(y,c,d.q,e.k,d.A),w=P(a,l,e.f(s),i,d.B(s),h,c+1);return Bn(a,y,e.k,d.q,An(w.us,c),e.s,n.def),Na(k(e.k,c,w.tm,e.s),o,Cn(w.us,c))}case"Let":{let d=e.k.length,s=[],l=b(),h=y;for(let U=0;U<d;U++){let F=Se(e.q[U],i),V=La(a,n,e.v[U],F,y,c),j=z(Z(jn(n,e.q[U])),e.s);try{P(a,n,V.ty,J(),j,y,c)}catch(H){let E=H;throw E?.$==="Err"&&E.exp===j?{...E,spn:e.s??E.spn}:H}s.push(V.tm),l=Fa(l,V.us),h=_a(h,c+U,e.q[U],e.k[U],V.ty)}let w=e.k.map((U,F)=>q(U,c+F,void 0,e.v[F])),T=P(a,n,e.f(w),i,o,h,c+d),N=T.us;for(let U=0;U<d;U++)Bn(a,y,e.k[U],e.q[U],An(N,c+U),e.s,n.def),N=Cn(N,c+U);return Na(ee(e.k,w.map((U,F)=>c+F),s,T.tm,e.s,e.q),o,Fa(l,N))}case"Ctr":{let d=$(a,o);if(d.$!=="ADT"){let N=Ga(a,e.k)===null?null:un(a,e.k);throw g(a,y,o,N===null?re(a,y,e):I(N,e.s),e.s,n.def)}let s=Ge(a,d,y,n.def),l=Vn(s.c,e.k);if(l===null){if(Ga(a,e.k)===null)throw g(a,y,"a declared constructor ("+d.k+" declares "+s.c.map((N)=>N.k).join(", ")+")",e,e.s,n.def);throw g(a,y,o,I(un(a,e.k),e.s),e.s,n.def)}if(e.x.length!==l.n)throw g(a,y,e.k+" with "+String(l.n)+(l.n===1?" field":" fields"),e,e.s,n.def);let h=tn(a,l.T,d.x,y,n.def,e.s),w=[],T=b();for(let N of e.x){let U=za(a,h,y,n.def,e.s),F=Se(U.q,i),V=P(a,n,N,F,U.A,y,c);w.push(V.tm),T=Fa(T,V.us),h=U.B(N)}return Na(K(e.k,w,e.s),o,T)}case"Mat":case"Efq":{let d=$(a,o);if(d.$!=="All")throw g(a,y,o,re(a,y,e),e.s,n.def);if(i.$!=="None"&&d.q.$==="None")throw g(a,y,"a live scrutinee (a - scrutinee matches only in a dead region)",void 0,e.s,n.def);let s=$(a,d.A);if(s.$!=="ADT")throw g(a,y,"a datatype",d.A,e.s,n.def);let l=Ge(a,s,y,n.def).c;switch(e.$){case"Efq":{if(l.length!==0&&!Ii(a,y))throw g(a,y,"cases for "+l.map((h)=>h.k).join(", "),e,e.s,n.def);return Na(Da(e.s),o,b())}case"Mat":{let U=function(E,Te,Nn){if(Te===0)return w.B(K(h.k,Nn,h.s));else{let Xa=za(a,E,y,n.def,h.s),Ui=Ci(Xa.q,w.q);return m(Ui,Xa.k,Xa.i,Xa.A,(Un)=>{return U(Xa.B(Un),Te-1,Nn.concat([Un]))},h.s)}},h=e,w=d,T=Vn(l,e.k);if(T===null)throw g(a,y,"a constructor of "+s.k+" (missing, or already matched)",e,e.ks??e.s,n.def);let N=tn(a,T.T,s.x,y,n.def,e.s),F=n;if(n.n>0)F={...n,t:ke(n.t,e.k,T.n),n:n.n-1+T.n};let V=P(a,F,e.h,i,U(N,T.n,[]),y,c),j=m(d.q,d.k,d.i,sa(s.k,s.x,e.s,s.r.concat([T.k])),d.B,e.s),H=P(a,n,e.m,i,j,y,c);return Na(Ba(e.k,V.tm,H.tm,e.s,e.ks),o,Vi(V.us,H.us))}}}case"Rfl":{let d=$(a,o);if(d.$!=="Eql")throw g(a,y,o,re(a,y,e),e.s,n.def);if(!v("EQ",a,d.a,d.b,c))throw g(a,y,d.a,d.b,e.s,n.def);return Na(Ka(e.s),o,b())}case"Hol":{if(e.k==="TODO")return Na(ie(e.k,e.s),o,b());throw g(a,y,o,e,e.s,n.def)}case"Rwt":{let d=La(a,n,e.e,i,y,c),s=$(a,d.ty);if(s.$!=="Eql")throw g(a,y,"an equation {a == b : T}",d.ty,e.e.s??e.s,n.def);let l=m(t(),"_",0,s.T,(U)=>m(t(),"e",0,ga(s.a,U,s.T),()=>z(Z(t())),e.s),e.s),h=P(a,n,e.p,J(),l,y,c),w=aa(aa(e.p,s.b),e.e);if(!v("LE",a,w,o,c))throw g(a,y,o,w,e.s,n.def);let T=aa(aa(e.p,s.a),Ka(e.s)),N=P(a,n,e.f,i,T,y,c);return Na(ne(d.tm,h.tm,N.tm,e.s),o,Fa(d.us,N.us))}default:break}let f=La(a,n,e,i,y,c);if(v("LE",a,f.ty,o,c))return{tm:f.tm,us:f.us};throw g(a,y,o,f.ty,e.s,n.def)}function lo(a,n,e){P(a,{t:I(n),n:0,def:n,qs:[]},e.T,J(),z(Z(t())),L(),0);let i=e.T,o=L();for(let c=0;c<e.n;c++){let f=za(a,i,o,n,e.T.s);o=_a(o,c,f.q,f.k,f.A),i=f.B(q(f.k,c))}let y=$(a,i);if(y.$!=="Typ")throw g(a,o,"a kind (type "+n+"<..> is Kind(g))",y,i.s??e.T.s,n);for(let c of e.c){let f=c.T,d=L();for(let h=0;h<e.n+c.n;h++){let w=za(a,f,d,c.k),T=z(Z(w.q));if(h>=e.n&&w.q.$==="Lone")T=y;P(a,{t:I(c.k),n:0,def:c.k,qs:[]},w.A,J(),T,d,h),d=_a(d,h,w.q,w.k,w.A),f=w.B(q(w.k,h))}let s="a telescope tipped at "+n+" applied to its own parameters",l=$(a,f);if(l.$!=="ADT"||l.k!==n||l.x.length!==e.n||l.r.length!==0)throw g(a,d,s,l,void 0,c.k);for(let h=0;h<e.n;h++){let w=$(a,l.x[h]);if(w.$!=="Var"||w.i!==h)throw g(a,d,s,l,void 0,c.k)}}}function wo(a,n,e){if(P(a,{t:I(n),n:0,def:n,qs:[],u:e.u},e.T,J(),z(Z(t())),L(),0),e.i){let i=_(e.T);for(let c=0;i.$==="All";c++)i=_(i.B(q(i.k,c)));let[o]=Ce(i),y=a.tlds.IO;if(o.$!=="Ref"||o.k!=="IO"||y===void 0||y.$!=="Def"||y.b!==!0)throw g(a,L(),"a foreign definition returning base IO(...) directly (return type aliases are not unfolded)",n,i.s,n)}if(e.v!==null){let i=ti(a,e.T).doms.map((o)=>o[0]).slice(0,e.n);while(i.length<e.n)i.push(t());e.e=P(a,{t:I(n),n:e.n,def:n,qs:i,u:e.u},e.v,t(),e.T,L(),0).tm}}function mn(a,n=0){let e=fa(),i=new Map;for(let o=0;o<a.order.length;o++)i.set(a.order[o],o);for(let o=0;o<a.order.length;o++){let y=a.order[o],c=a.tlds[y],f=i.get(y)===o;if(c.$==="ADT"){e.tlds[y]=c;for(let s of c.c)e.ctrs[s.k]=s;if(o>=n)lo(e,y,c);continue}let d={$:"Def",n:c.n,T:c.T,v:null,b:c.b,u:c.u};if(o<n){e.tlds[y]=f?c:d;continue}if(f&&c.v===null&&c.b!==!0&&!c.i)a.open+=1;e.tlds[y]=d,wo(e,y,f?c:d),e.tlds[y]=f?c:d}}var kn=`
...
`;var _n=`# Winning Is Impossible -- the game.
#
...
`;var pn=`# The laws. The human states them; PROOF.bend must prove them.
...
`;var ai=`# Winning Is Impossible -- the certificate.
#
...
`+ei,di={"main.bend":_n,"LAWS.bend":pn,"PROOF.bend":ai};p.set("/bend2/base.bend",kn);for(let a of wn)p.set(le+a,di[a]);p.set(le+"ALL.bend",`import Base
import ./main.bend as Game
import ./LAWS.bend as Laws
import ./PROOF.bend as Proof
`);function we(a){let n=a;return n?.$==="Err"?Jn(n):String(a?.message??a)}async function Le(a){let n=fa();try{await We(n,le+a,"",new Map),mn(n)}catch(y){return{ok:!1,text:we(y),hols:0,uns:0}}let e=[...new Set(n.order)].filter((y)=>n.tlds[y].u===!0).length+Object.values(n.tmps).filter((y)=>y.u===!0).length,i=n.hols+n.open,o=i>0?String(i)+(i===1?" TODO":" TODOs")+` found.
The code is incomplete, and not a valid proof yet.`:e>0?String(e)+(e===1?" term":" terms")+` annotated as unsafe.
The code is well-typed, but may contain logical paradoxes.`:"All terms check.";return{ok:i===0&&e===0,text:o,book:n,hols:i,uns:e}}var ha=(a)=>I(a),qa=(a,...n)=>n.reduce((e,i)=>O(e,i),a),Ke=(a,...n)=>K(a,n),yn=(a)=>{let n=Ke("Zero");for(let e=0;e<a;e++)n=Ke("Succ",n);return n},Co=(a)=>a.reduceRight((n,e)=>Ke("Con",e,n),Ke("Nil"));function de(a,n,e){if(a.$!=="Ctr"||a.k!==n||a.x.length<e)throw Error("expected "+n+(e>0?" with "+e+" fields":"")+", got "+Ma(B(a)));return a.x}function cn(a){let n=0;while(a.$==="Ctr"&&a.k==="Succ"&&a.x.length===1)n++,a=a.x[0];return de(a,"Zero",0),n}function ii(a){if(a.$==="Ctr"&&a.x.length===0&&(a.k==="True"||a.k==="False"))return a.k==="True";throw Error("expected a Bool, got "+Ma(B(a)))}function Vo(a){let n="";while(a.$==="Ctr"&&a.k==="SCon"&&a.x.length===2){let e=pe(de(a.x[0],"Chr",1)[0]);if(e===null)throw Error("expected a Char, got "+Ma(B(a.x[0])));n+=String.fromCodePoint(e),a=a.x[1]}return de(a,"SNil",0),n}class je{book;constructor(a){this.book=a}snf(a){return D(this.book,a)}replay(a){let n=qa(ha("main.replay"),ha("main.start"),Co(a)),e=de(this.snf(n),"main.Game",3);return{x:cn(e[0]),y:cn(e[1]),won:ii(this.snf(qa(ha("main.is_won"),n)))}}key(a){let n=this.snf(qa(ha("main.key"),oe(a)));if(n.$==="Ctr"&&n.k==="None"&&n.x.length===0)return null;return de(n,"Some",1)[0]}nat(a){return cn(this.snf(ha("main."+a)))}grid(){return Vo(this.snf(qa(ha("main.grid"),qa(ha("Nat.sub"),ha("main.map_h"),yn(1)))))}flags(a,n){let e=this.snf(ha("LAWS.drawn")),i=[];for(let o=0;o<n;o++)for(let y=0;y<a;y++)i.push(ii(this.snf(qa(ha("LAWS.flag_at"),yn(o),yn(y),e))));return i}}function si(a){for(let n of["start","replay","is_won","map_w","map_h","grid","key"])if(a.book.tlds["main."+n]?.$!=="Def")return"main.bend must keep a def named "+n;try{a.replay([]);let n=a.nat("map_h"),e=a.nat("map_w"),i=a.grid().split(`
`);if(i.length!==n||i.some((o)=>o.length!==e))return"grid(map_h() - 1n) must answer map_h() rows of map_w() cells";a.flags(e,n);for(let o of Go){let y=a.key(o);if(y!==null)a.replay([y])}}catch(n){return we(n)}return null}var Ra,ce=[],ya,Oe=[],Za=12,Pe=8,dn=new Set,sn=new Set,Ca=null,Va=null,hi=0;function Tn(a){if(Ra=a,ce=[],ya=Ra.replay(ce),Oe=Ra.grid().split(`
`),Pe=Oe.length,Za=Math.max(...Oe.map((n)=>n.length)),dn=new Set,Oe.forEach((n,e)=>[...n].forEach((i,o)=>{if(i==="#")dn.add(o+","+e)})),sn=new Set,Ra.flags(Za,Pe).forEach((n,e)=>{if(n)sn.add(e%Za+","+Math.floor(e/Za))}),Ca=Va=null,Oa!==void 0)hi=performance.now()}function uo(a){let n;try{if(n=Ra.key(a),n===null)return!1;let{x:e,y:i}=ya;ce.push(n);try{ya=Ra.replay(ce)}catch(y){throw ce.pop(),y}let o={Up:[0,-1],Down:[0,1],Left:[-1,0],Right:[1,0]}[n.$==="Ctr"?n.k.replace(/^main\./,""):""];if(ya.x===e&&ya.y===i&&o!==void 0)Va={dx:o[0],dy:o[1],t0:performance.now()};else if(Math.abs(ya.x-e)<=1&&Math.abs(ya.y-i)<=1)Ca={fx:e,fy:i,t0:performance.now()}}catch(e){se("bad","the game crashed: "+we(e))}return!0}var la={floor:["#f3efe8","#e5e1d9"],wall:"#a6a3a0",cap:"#bebbb8",pole:"#87847d",cloth:"#7e9a5e",skin:"#78c0e3",eye:"#2f3b4c",win:"#f6e4e1",winRim:"#dfa9a2",winInk:"#c46a60"},Oo='ui-monospace,Menlo,"SF Mono",Consolas,monospace',oi=(a,n,e)=>a+(n-a)*e;function Io(a,n){let e=a.getContext("2d"),i=a.clientWidth,o=window.devicePixelRatio||1,y=i/Za,c=y*Pe;if(a.width!==Math.round(i*o)||a.height!==Math.round(c*o))a.width=Math.round(i*o),a.height=Math.round(c*o);e.setTransform(o,0,0,o,0,0),e.clearRect(0,0,i,c);let f=(N,U,F,V,j,H)=>{e.fillStyle=H,e.beginPath(),e.roundRect(N,U,F,V,j),e.fill()};for(let N=0;N<Pe;N++)for(let U=0;U<Za;U++){let F=U*y+1.5,V=N*y+1.5,j=y-3;if(!dn.has(U+","+N)){f(F,V,j,j,y/8,la.floor[(U+N)%2]);continue}f(F,V,j,j,y/8,la.wall),f(U*y+y/8,N*y+y/8,y*0.75,y*0.21,y/19,la.cap)}let d=y/40;for(let N of ya.won?[]:sn){let[U,F]=N.split(",").map((V)=>Number(V)*y);e.strokeStyle=la.pole,e.lineWidth=2.5,e.lineCap="round",e.beginPath(),e.moveTo(U+14*d,F+31*d),e.lineTo(U+14*d,F+9*d),e.stroke(),e.fillStyle=la.cloth,e.beginPath(),e.moveTo(U+15*d,F+9*d),e.lineTo(U+31*d,F+14.5*d),e.lineTo(U+15*d,F+20*d),e.closePath(),e.fill()}let{x:s,y:l}=ya;if(Ca!==null){let N=Math.min((n-Ca.t0)/90,1);if(s=oi(Ca.fx,s,N),l=oi(Ca.fy,l,N),N===1)Ca=null}if(Va!==null){let N=(n-Va.t0)/120;if(N<1)s+=Va.dx*0.3*(1-N),l+=Va.dy*0.3*(1-N);else Va=null}let h=s*y+y/2,w=l*y+y/2;e.fillStyle=la.skin,e.beginPath(),e.arc(h,w,12.5*d,0,Math.PI*2),e.fill(),e.fillStyle=la.eye,e.beginPath(),e.arc(h-4.5*d,w-2*d,2.2*d,0,Math.PI*2),e.arc(h+4.5*d,w-2*d,2.2*d,0,Math.PI*2),e.fill();let T=(n-hi)/900;if(T<1)e.fillStyle="rgba(126,154,94,"+(0.45*(1-T)*(1-T)).toFixed(3)+")",e.beginPath(),e.roundRect(0,0,i,c,y/8),e.fill();if(ya.won){let N=y*5.6,U=y*1.5,F=(i-N)/2,V=(c-U)/2;e.fillStyle=la.win,e.strokeStyle=la.winRim,e.lineWidth=1.5,e.beginPath(),e.roundRect(F,V,N,U,10),e.fill(),e.stroke(),e.fillStyle=la.winInk,e.font="600 "+y*0.6+"px "+Oo,e.textAlign="center",e.fillText("YOU WON !?",i/2,V+U*0.66)}}var ja={type:"string"},Ie=(a,n,e)=>({type:"function",name:a,description:n,strict:!0,parameters:{type:"object",properties:e,required:Object.keys(e),additionalProperties:!1}}),xo=[Ie("read_file","Read one of the files. Paths: main.bend, LAWS.bend, PROOF.bend.",{path:ja}),Ie("write_file","Replace the whole content of main.bend or PROOF.bend. LAWS.bend is read-only.",{path:ja,content:ja}),Ie("edit_file","Replace one exact occurrence of `old` with `new` in main.bend or PROOF.bend. `old` must occur exactly once, indentation included.",{path:ja,old:ja,new:ja}),Ie("submit","Submit the files. Bend checks main.bend, then main.bend, LAWS.bend and PROOF.bend together: no error, both laws proved, no TODO, no @unsafe, LAWS.bend untouched, and the front end's API intact. Accepted work goes live at once. A rejection answers the first error with its file and location: fix it and submit again.",{})];async function li(){if(p.get(le+"LAWS.bend")!==di["LAWS.bend"])return{game:!1,text:"LAWS.bend was changed"};let a=await Le("main.bend");if(!a.ok)return{game:!1,text:"main.bend: "+a.text};let n=await Le("ALL.bend");if(!n.ok){let o=n.book===void 0?[]:[...new Set(n.book.order)].filter((y)=>y.startsWith("LAWS.")&&n.book.tlds[y].v===null);return{game:!1,text:o.length>0?"the law "+o[0].slice(5)+" has no proof: PROOF.bend must fill def Laws."+o[0].slice(5):"PROOF.bend: "+n.text}}let e=new je(n.book),i=si(e);if(i!==null)return{game:!0,text:i};return Tn(e),null}var $a=null;async function wi(a,n){let e=String(n.path??"").replace(/^\.?\//,"");if(a!=="submit"&&!wn.includes(e))return"no such file: "+e+" (the files are main.bend, LAWS.bend, PROOF.bend)";let i=le+e;switch(a){case"read_file":return p.get(i);case"write_file":if(e==="LAWS.bend")return"LAWS.bend is the human's file: read-only.";return p.set(i,n.content),"wrote "+e+" ("+n.content.split(`
`).length+" lines)";case"edit_file":{if(e==="LAWS.bend")return"LAWS.bend is the human's file: read-only.";let o=p.get(i),y=o.split(n.old).length-1;if(y!==1)return y===0?"old text not found in "+e+" (it must match exactly, indentation included)":"old text occurs "+y+" times in "+e+"; include more context so it is unique";return p.set(i,o.replace(n.old,()=>n.new)),"edited "+e}case"submit":return $a=await li(),$a===null?"Accepted. The new game is live.":"Rejected: "+$a.text;default:return"unknown tool "+a}}async function Ti(a,n,e){let i=await fetch(So,{method:"POST",signal:n,headers:{"Content-Type":"application/json",Authorization:"Bearer "+De()},body:JSON.stringify(a)});if(!i.ok){let d=i.status+" "+i.statusText;try{d=(await i.json()).error?.message??d}catch{}throw Error(d)}let o=i.body.getReader(),y=new TextDecoder,c="",f=null;for(;;){let{value:d,done:s}=await o.read();if(s)break;c+=y.decode(d,{stream:!0});let l;while((l=c.indexOf(`

`))>=0){let h=c.slice(0,l);c=c.slice(l+2);let w=h.split(`
`).filter((N)=>N.startsWith("data:")).map((N)=>N.slice(5).trim()).join(`
`);if(w===""||w==="[DONE]")continue;let T=JSON.parse(w);if(T.type==="response.completed"||T.type==="response.incomplete")f=T.response;else if(T.type==="response.failed"||T.type==="error")throw Error(T.error?.message??T.response?.error?.message??"the model failed");else e(T)}}if(f===null)throw Error("the stream ended before the response completed");return f}var ze=!1,ve=null,fn=!0,xe=null;async function to(a){ze=!0,ve=new AbortController;let n=ve.signal;ua("u",a),he();let e=!1,i=!1,o=0,y=[{role:"user",content:a}];try{for(;;){let c=ci("th"),f=ci("a"),d=[],s=()=>Ti({model:ln(),instructions:Ao,input:y,tools:xo,previous_response_id:xe,stream:!0,store:!0,service_tier:"fast",reasoning:fn?{effort:"high",summary:"auto"}:{effort:"high"}},n,(h)=>{if(h.type==="response.reasoning_summary_text.delta")c.add(h.delta);else if(h.type==="response.reasoning_summary_part.added")c.add(c.text()?`

`:"");else if(h.type==="response.output_text.delta")f.add(h.delta);else if(h.type==="response.output_item.done"&&h.item.type==="function_call")d.push(h.item)});if(xe=(await s().catch((h)=>{let w=String(h?.message);if(fn&&/summar/i.test(w))return fn=!1,s();if(xe!==null&&/previous_response|not found/i.test(w))return xe=null,s();throw h})).id,d.length===0){if(i||e)break;e=!0,y=[{role:"user",content:"You stopped without calling submit. If the change is done, call submit now. If it cannot be done under the law, say so in one or two sentences."}];continue}y=[];for(let h of d){let w={};try{w=JSON.parse(h.arguments||"{}")}catch{}let T=await wi(h.name,w);if(Lo(h.name,w,T),h.name==="submit"&&T.startsWith("Accepted"))i=!0;y.push({type:"function_call_output",call_id:h.call_id,output:T}),o+=1}if(o>=ni){se("bad","Stopped after "+ni+" tool calls. Send another prompt to go on.");break}}}catch(c){se(n.aborted?"dim":"bad",n.aborted?"Stopped.":"Error: "+we(c))}ze=!1,ve=null,he()}var vo=`
...
`;function S(a,n={},...e){let i=document.createElement(a);for(let[o,y]of Object.entries(n))i.setAttribute(o,y);return i.append(...e),i}var yi,Oa,te,X,Ta,fe,Ja,hn=!1,De=()=>localStorage.getItem("bend.lab.key")??"",ln=()=>localStorage.getItem("bend.lab.model")??Fo;function qe(){Oa.scrollTop=Oa.scrollHeight}function ua(a,n){let e=S("div",{class:a},n);return Oa.append(e),qe(),e}var se=(a,n)=>{if(Oa!==void 0)ua(a,n)};function ci(a){let n=null;return{add:(e)=>{if(n===null)n=ua(a,"");n.append(e),qe()},text:()=>n?.textContent??""}}function Lo(a,n,e){let i=n.path??"",o=(c,f)=>S("pre",{class:c},f),y=(c,...f)=>S("details",{},S("summary",{},c),...f);if(a==="read_file")ua("tc","read "+i);else if(a==="write_file")ua("tc","write "+i).append(wn.includes(i)&&i!=="LAWS.bend"?y(e,o("",n.content)):o("err",e));else if(a==="edit_file")ua("tc","edit "+i).append(e.startsWith("edited")?y(e,o("","- "+n.old.split(`
`).join(`
- `)+`
+ `+n.new.split(`
`).join(`
+ `))):o("err",e));else if(a==="submit"){let c=ua("tc","submit");if($a===null)c.append(S("div",{class:"ok"},"✓ Accepted. The new game is live: play it above."));else{let f=S("a",{class:"bad"},"Your program broke the "+($a.game?"game":"law")+". Try again."),d=o("err",$a.text);d.hidden=!0,f.onclick=()=>{d.hidden=!d.hidden,qe()},c.append(`
`,f,d)}}qe()}function he(){if(fe.replaceChildren(),ze){let e=S("a",{},"stop");e.onclick=()=>ve?.abort(),fe.append(S("span",{},"working…"),e),X.disabled=!0;return}X.disabled=!1;let a=S("a",{title:"change the model"},ln());a.onclick=()=>{let e=prompt("OpenAI model id",ln());if(e)localStorage.setItem("bend.lab.model",e.trim()),he()};let n=S("a",{title:"change the key"},De()?"key ····"+De().slice(-4):"no key");n.onclick=()=>{Ja.replaceChildren(S("span",{},"key"),Ta),Ta.focus()},fe.append(S("span",{},a," · thinking high · fast · ",n),S("span",{},"byok · your key stays in this browser"))}function Ko(){let a=X.value.trim();if(a===""||ze)return;if(De()===""){Ja.replaceChildren(S("span",{},"key"),Ta),Ta.focus(),se("dim","Paste your OpenAI API key first. It is kept in this browser only and sent to api.openai.com alone.");return}X.value="",X.style.height="",to(a)}function Po(){document.head.append(S("style",{},vo)),te=S("canvas");let a=S("a",{title:"close"},"×");a.onclick=()=>Ni(!1),X=S("textarea",{placeholder:"make the walls disappear",rows:"1"}),X.oninput=()=>{X.style.height="",X.style.height=Math.min(X.scrollHeight,150)+"px"},X.onkeydown=(o)=>{if(o.key==="Enter"&&!o.shiftKey)o.preventDefault(),Ko();if(o.key==="Escape")X.blur()},te.onclick=()=>X.blur(),Ta=S("input",{type:"password",placeholder:"OpenAI API key, then Enter",autocomplete:"off"}),Ta.onkeydown=(o)=>{if(o.key==="Enter")localStorage.setItem("bend.lab.key",Ta.value.trim()),Ta.value="",Ja.replaceChildren(S("span",{},">"),X),he(),X.focus();else if(o.key==="Escape")Ja.replaceChildren(S("span",{},">"),X),X.focus()},Ja=S("div",{class:"box"},S("span",{},">"),X),fe=S("div",{class:"meta"}),Oa=S("div",{class:"chat"}),yi=S("div",{id:"lab"},S("div",{class:"top"},S("div",{class:"hd"},S("span",{},S("b",{},"Winning Is Impossible")," · live demo"),a),te,S("p",{class:"how"},S("b",{},"Grab the flag to win."),`
`,S("span",{class:"dim"},"WASD to move"),`

`,"Can't win? Prompt the AI below to ",S("b",{},"edit the game"),`.
You can ask `,S("i",{},"anything"),". ",S("b",{},"Bend")," guards it. Good luck!")),Oa,S("div",{class:"in"},Ja,fe));let n=S("div",{id:"page"}),e=S("div",{id:"pagein"});while(document.body.firstChild)e.append(document.body.firstChild);n.append(e),document.body.append(n,yi),document.addEventListener("keydown",(o)=>{if(!hn)return;let y=o.target;if(y===X||y===Ta||o.metaKey||o.ctrlKey||o.altKey)return;let c=Wo[o.key]??o.key;if(c.length!==1)return;if(uo(c.toLowerCase().charCodeAt(0)))o.preventDefault()});let i=(o)=>{if(hn)Io(te,o);requestAnimationFrame(i)};requestAnimationFrame(i)}function Ni(a){let n=document.getElementById("page"),e=a?window.scrollY:n.scrollTop;if(hn=a,document.documentElement.classList.toggle("lab",a),a)n.scrollTop=e;else window.scrollTo(0,e);if(a)he()}async function fi(){let a=document.getElementById("try");if(a===null)return;Po();let n=null,e=()=>{return n??=Le("ALL.bend").then((i)=>{if(!i.ok)throw Error(i.text);Tn(new je(i.book)),Ni(!0)}),n.catch((i)=>se("bad","the game did not compile: "+we(i))),n};if(a.addEventListener("click",(i)=>{i.preventDefault(),e()}),location.hash==="#lab")e()}if(typeof document<"u")if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",fi);else fi();})();
